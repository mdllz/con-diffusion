...
plot.util1 <- coef(wienermodel1, probs = c(0.025, 0.975))$pers[,,3] %>%
  ...
  geom_hline(yintercept = 0,
             alpha = 0.50, color = "red") +
  geom_hline(yintercept = posterior_summary(wienermodel1, pars = "b_")[5,1],
             alpha = 0.50,
             linetype = "twodash") +
  geom_point(aes(x = index, 
                 y = Estimate,
...
plot.util2 <- coef(wienermodel2, probs = c(0.025, 0.975))$pers[,,3] %>%
  ...
  geom_hline(yintercept = 0,
             alpha = 0.50, color = "red") +
  geom_hline(yintercept = posterior_summary(wienermodel2, pars = "b_")[5,1],
             alpha = 0.50,
             linetype = "twodash") +
  geom_point(aes(x = index, 
                 y = Estimate,
