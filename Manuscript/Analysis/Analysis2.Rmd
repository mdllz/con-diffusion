...
stim <- dat2 %>% 
            select(itemid, orig.rating_s, util.rating_s) %>% 
            distinct()

cor.orig.util <- correlationBF(stim$orig.rating_s, stim$util.rating_s, posterior = T, iterations = 10000)
mean(cor.orig.util[,"rho"])

BF.cor.orig.util <- correlationBF(stim$orig.rating_s, stim$util.rating_s)
...
cor.rtmeans.orig <- correlationBF(stim$orig.rating_s, stim$rt.meansALL, posterior = T, iterations = 10000)
mean(cor.rtmeans.orig[,"rho"])

BF.cor.rtmeans.orig <- correlationBF(stim$orig.rating_s, stim$rt.meansALL)
exp(BF.cor.rtmeans.orig@bayesFactor$bf)


# Correlation response times and utility

cor.rtmeans.util <- correlationBF(stim$util.rating_s, stim$rt.meansALL, posterior = T, iterations = 10000)
mean(cor.rtmeans.util[,"rho"])

BF.cor.rtmeans.util <- correlationBF(stim$util.rating_s, stim$rt.meansALL)
...
cor.rtmeans.orig.crea <- correlationBF(stim$orig.rating_s, stim$rt.meansC,  posterior = T, iterations = 10000)
mean(cor.rtmeans.orig.crea[,"rho"])

BF.cor.rtmeans.orig.crea <- correlationBF(stim$orig.rating_s, stim$rt.meansC)
exp(BF.cor.rtmeans.orig.crea@bayesFactor$bf)
  
# Correlation response time means "creative" and utility

cor.rtmeans.util.crea <- correlationBF(stim$util.rating_s, stim$rt.meansC, posterior = T, iterations = 10000)
mean(cor.rtmeans.util.crea[,"rho"])

BF.cor.rtmeans.util.crea <- correlationBF(stim$util.rating_s, stim$rt.meansC)
...
cor.rtmeans.orig.notcrea <- correlationBF(stim$orig.rating_s, stim$rt.meansNC, iterations = 10000, posterior = T)
mean(cor.rtmeans.orig.notcrea[,"rho"])

BF.cor.rtmeans.orig.notcrea <- correlationBF(stim$orig.rating_s, stim$rt.meansNC)
exp(BF.cor.rtmeans.orig.notcrea@bayesFactor$bf)


# Correlation response times "not creative" and utility

cor.rtmeans.util.notcrea <- correlationBF(stim$util.rating_s, stim$rt.meansNC, posterior = T, iterations = 10000)
mean(cor.rtmeans.util.notcrea[,"rho"])

BF.cor.rtmeans.util.notcrea <- correlationBF(stim$util.rating_s, stim$rt.meansNC)
...
prior <- above0.prior/nrow(prior.i) # 23 percent evidential iterations
...
# remove participants' data with less than 90 percent valid responses
dat_AUT2 <- clean_aut_data(dat_AUT2_r) %>%
  # remove 17 invalid responses: orig & util = 0
