...
---
```{r 'FAplot1', dev = "pdf", dpi = 300, fig.pos = "H", fig.width = 4.2, fig.cap = "Posterior predictive check of Study 1. The inner vertical lines show the 80$\\%$ CrIs and the outer vertical lines the 95$\\%$ CrIs. The red cross denotes the observed and the black circle the predicted statistics. The model could reproduce the three summary statistics quite accurately.", fig.align = 'center'}
