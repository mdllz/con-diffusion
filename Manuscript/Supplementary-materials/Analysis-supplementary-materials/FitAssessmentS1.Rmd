...
```{r 'sampling from post pred distribution', include = F, eval = T}
...
pred_wienerS1.bias2 <- predict(wienermodel1, 
                       summary = FALSE, 
                       negative_rt = TRUE, 
                       nsamples = samples1)

save(pred_wienerS1.bias, file = "pred_wienerS1.bias2.Rda",  compress = "xz")
```
...
d_data <- as_tibble(cbind(dat1, as_tibble(t(pred_wienerS1.bias2))))
```
